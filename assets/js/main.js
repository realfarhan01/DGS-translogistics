...
const leftSliderTrack = document.querySelector('.left-start .clients-slider-track');
const rightSliderTrack = document.querySelector('.right-start .clients-slider-track');
const leftSlides = document.querySelectorAll('.left-start .clients-slide');
const rightSlides = document.querySelectorAll('.right-start .clients-slide');
leftSlides.forEach(slide => {
    leftSliderTrack.appendChild(slide.cloneNode(true));
});
rightSlides.forEach(slide => {
    rightSliderTrack.appendChild(slide.cloneNode(true));
});
const sliders = document.querySelectorAll('.clients-slider');

sliders.forEach(slider => {
    slider.addEventListener('mouseenter', () => {
        slider.querySelector('.clients-slider-track').style.animationPlayState = 'paused';
    });
    
    slider.addEventListener('mouseleave', () => {
        slider.querySelector('.clients-slider-track').style.animationPlayState = 'running';
    });
...
function adjustAnimationSpeed() {
    const leftTrack = document.querySelector('.left-start .clients-slider-track');
    const rightTrack = document.querySelector('.right-start .clients-slider-track');
    
    if (window.innerWidth <= 768) {
        leftTrack.style.animationDuration = '25s';
        rightTrack.style.animationDuration = '25s';
    } else if (window.innerWidth <= 480) {
        leftTrack.style.animationDuration = '20s';
        rightTrack.style.animationDuration = '20s';
    } else {
        leftTrack.style.animationDuration = '30s';
        rightTrack.style.animationDuration = '30s';
    }
}
